...
export type FetchUserSocialCapitalScoreQueryVariables = Exact<{
  username: Scalars['Identity']['input'];
}>;


export type FetchUserSocialCapitalScoreQuery = { Socials: { Social: Array<{ profileImage: string | null, profileHandle: string | null, profileDisplayName: string | null, profileName: string | null, isFarcasterPowerUser: boolean | null, userId: string | null, identity: any | null, custodyAddress: any | null, socialCapital: { socialCapitalScoreRaw: string | null, socialCapitalScore: number | null, socialCapitalRank: number | null } | null }> | null } | null };

export type FetchUserFriendsBySocialCapitalScoreQueryVariables = Exact<{
  scs_gt: InputMaybe<Scalars['Float']['input']>;
  scs_lt: InputMaybe<Scalars['Float']['input']>;
  userId: InputMaybe<Scalars['String']['input']>;
  limit: InputMaybe<Scalars['Int']['input']>;
}>;


export type FetchUserFriendsBySocialCapitalScoreQuery = { Socials: { Social: Array<{ profileName: string | null, identity: any | null, profileBio: string | null, profileImage: string | null, profileHandle: string | null, profileDisplayName: string | null, isFarcasterPowerUser: boolean | null, fid: string | null, custodyAddress: any | null, connectedAddresses: Array<{ address: any | null, blockchain: string | null }> | null, socialCapital: { socialCapitalScore: number | null } | null, followers: { Follower: Array<{ id: string | null, dappName: string | null, followerProfileId: string | null, followingProfileId: string | null }> | null } | null }> | null } | null };

export type FetchUserMutualFriendsQueryVariables = Exact<{
  viewerAddress: InputMaybe<Scalars['Identity']['input']>;
  frenAddress: InputMaybe<Scalars['Identity']['input']>;
}>;


export type FetchUserMutualFriendsQuery = { SocialFollowings: { Following: Array<{ followingAddress: { socialFollowers: { Follower: Array<{ followerAddress: { socials: Array<{ fnames: Array<string | null> | null, profileName: string | null, profileTokenId: string | null, profileTokenIdHex: string | null, userId: string | null, userAssociatedAddresses: Array<any> | null }> | null } | null }> | null } | null } | null }> | null } | null };
